...
with open("data/schema.sql", encoding="utf-8") as fh:
    sql_text = fh.read()
...
with open("output/schema.json", "w", encoding="utf-8") as fh:
...
#         else:
#             # if passed as "table.column"
#             valid_columns.add(col.split(".")[-1].lower())

#     # -------------------------------
#     # 2. Remove aliases (AS xxx)
#     # -------------------------------
#     sql_clean = re.sub(r'\bas\s+\w+', '', sql_lower)

#     # -------------------------------
#     # 3. Extract column references
#     # matches: a.column OR column
#     # -------------------------------
#     tokens = re.findall(r'\b\w+\.\w+\b|\b\w+\b', sql_clean)

#     # -------------------------------
#     # 4. Filter real column candidates
#     # -------------------------------
#     keywords = {
#         "select", "from", "join", "on", "where", "and", "or",
#         "inner", "left", "right", "group", "by", "order",
#         "as", "case", "when", "then", "end", "nullif",
...
#         if col not in keywords and not col.isdigit():
#             used_columns.add(col)
    ...
    # if invalid_cols:
    #     return False, f"Hallucinated columns: {invalid_cols}"
